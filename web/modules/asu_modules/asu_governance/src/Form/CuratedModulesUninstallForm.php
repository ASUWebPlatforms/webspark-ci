 ...
 */
class CuratedModulesUninstallForm extends FormBase {
  ...
  /**
   * Constructs a CuratedModulesUninstallForm object.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $uninstallable_asu = array_filter($uninstallable, function ($module) {
    ...
    uasort($uninstallable_asu, function ($a, $b) use ($unstable_lifecycle) {
    ...
    $validation_reasons = $this->moduleInstaller->validateUninstall(array_keys($uninstallable_asu));

    $form['uninstall'] = ['#tree' => TRUE];
    foreach ($uninstallable_asu as $module_key => $module) {
      $name = $module->info['name'] ?: $module->getName();
      $form['modules'][$module->getName()]['#module_name'] = $name;
      $form['modules'][$module->getName()]['name']['#markup'] = $name;
      $description = $module->info['description'];
      $form['modules'][$module->getName()]['description']['#markup'] = $this->t('@description', ['@description' => $description]);
